<?php
    ...
    if(!empty($file_name)){
      ...
      $ext2=substr($file_name, -4);
        if($ext!=='jpg'&&$ext!=='png'&&$ext!=='gif'&&$ext2!=='jpeg'){
        ...
        <form method="post" action="" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <?php if(isset($_POST['nick_name'])){ ?>
              <input type="text" name="nick_name" class="form-control" placeholder="例： seed" value="<?php echo htmlspecialchars($_POST['nick_name'],ENT_QUOTES, 'UTF-8'); ?>">
            <?php }else{ ?>
              <input type="text" name="nick_name" class="form-control" placeholder="例： seed">
            <?php } ?>
          ...
          <div class="form-group">
            ...
            <p class="error">*画像はjpg,png,gif,jpegのいずれかにしてください。</p>
            <?php } ?>
